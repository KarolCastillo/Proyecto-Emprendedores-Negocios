...
@section('contenido')
    ...
    <div class="p-3 bg-white mb-4">
        ...
        <div class="row">
                <div class="col-md-2">
                    <a type="button " href="{{ url('/Parking')}}" class="btn btn-primary mb-3 mt-2 mr-2 md-3 offset float-left">NUEVO  <i class="fas fa-plus"></i></a>
                </div>
                <div class="col-md-6">
                    <label for="exampleFormControlInput1" class="form-label">Fecha</label>
                        <input type="date"value="{{$fecha}}"  class="form-control" name="fecha" id="exampleFormControlInput1" placeholder="Col. el INDE">
                </div>
            <div class="col-md-4">
